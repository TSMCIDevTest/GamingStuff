...
export async function GET(req) {
  try {
    ...
    <svg width="600" height="160" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="165" y="85" fill="#cfd8ff" font-size="14" font-family="Arial">
        ${data.status || "Unknown"}
      </text>

      <text x="150" y="110" fill="#9fb3ff" font-size="16" font-family="Arial">
        🎮 ${gameText}
      </text>

      <text x="150" y="135" fill="#ffd700" font-size="14" font-family="Arial">
