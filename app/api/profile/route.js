...
// Helper to convert an image URL to a Base64 Data URI
async function getBase64Image(url) {
  try {
    ...
    // Fallback to a transparent pixel if the fetch fails
...
export async function GET(req) {
  try {
    ...
    if (format === "svg") {
      ...
      // CRITICAL FIX: Convert the avatar URL to a Base64 string
      ...
      <svg width="600" height="160" xmlns="http://www.w3.org/2000/svg">
        ...
        <image href="${base64Avatar}" x="40" y="40" width="80" height="80" clip-path="url(#circle)" />
